    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        UploadName = c.String(),
                        PrintImage = c.Binary(),
                        PrintSizeId = c.Int(nullable: false),
                        PrintAreaId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.UploadId)
                .ForeignKey("dbo.DesignAreas", t => t.PrintAreaId, cascadeDelete: true)
                .ForeignKey("dbo.DesignSizes", t => t.PrintSizeId, cascadeDelete: true)
                .Index(t => t.PrintSizeId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        DsizeId = c.Int(nullable: false, identity: true),
                        SizeName = c.String(),
                    })
                .PrimaryKey(t => t.DsizeId);
                ...
                c => new
                    {
                        ...
                        Feedback_Feed_ID = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Feedbacks", t => t.Feedback_Feed_ID)
                .Index(t => t.UserName, unique: true, name: "UserNameIndex")
                .Index(t => t.Feedback_Feed_ID);
        ...
        {
            DropForeignKey("dbo.Specials", "Category_ID", "dbo.Categories");
            DropForeignKey("dbo.Cart_Items", "Special_specialId", "dbo.Specials");
            ...
            DropForeignKey("dbo.Orders", "Email", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUsers", "Feedback_Feed_ID", "dbo.Feedbacks");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Designs", "DesignTypeId", "dbo.DesignTypes");
            DropForeignKey("dbo.UploadDesigns", "PrintSizeId", "dbo.DesignSizes");
            DropForeignKey("dbo.UploadDesigns", "PrintAreaId", "dbo.DesignAreas");
            ...
            DropIndex("dbo.Specials", new[] { "Category_ID" });
            ...
            DropIndex("dbo.AspNetUsers", new[] { "Feedback_Feed_ID" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Designs", new[] { "DesignTypeId" });
            DropIndex("dbo.UploadDesigns", new[] { "PrintAreaId" });
            DropIndex("dbo.UploadDesigns", new[] { "PrintSizeId" });
            DropIndex("dbo.Payments", new[] { "Email" });
            DropIndex("dbo.Categories", "Category_Index");
            DropIndex("dbo.Products", new[] { "Category_ID" });
            DropIndex("dbo.Cart_Items", new[] { "Special_specialId" });
            ...
            DropTable("dbo.DesignSizes");
            DropTable("dbo.UploadDesigns");
