...
namespace ABIY_One.Controllers
{
    public class EnquiriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Enq_Id,FullName,Email,Message,date,PhoneNumber")] Enquiry enquiry)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Enq_Id,FullName,Email,Message,date,PhoneNumber")] Enquiry enquiry)
        {
            if (ModelState.IsValid)
            {
