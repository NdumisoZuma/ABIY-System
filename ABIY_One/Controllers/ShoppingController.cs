...
namespace ABIY_One.Controllers
{
    public class ShoppingController : Controller
    {
        ...
        public ActionResult ShoppingCart()
        {
            ...
            //here
            ViewBag.Design = new SelectList( db.Designs,"DesignId","DesignName");
        ...
        //{
           // Order_Address oa = new Order_Address();
        //    double price = 50;
        //    double total = 0;
        ...
        [HttpPost]
        public ActionResult DeliveryOption(string colorRadio, string Street, string City, string PostalCode)//, int Distance)
        {
            ...
            if (item != null)
            {
                ...
                if (cartItem == null)
                {
                    ...
                    db.Cart_Items.Add(entity: new Cart_Items()
                    {
                        ...
                        quantity = 1,
                        price = item.Price//+(double)cartItem.Design.DesignPrice
                    }
                        );
                }
                else
